...
public class PruebaEva03 {
	...
	public void queSePuedaCrearUnNadador() {
		...
		assertEquals((Integer)1, nuevo.getNum_socio());
	}
	...
	public void queSePuedaCrearUnCorredor() {
		...
		assertEquals((Integer)2, nuevo.getNum_socio());
	}
	...
	public void  queSePuedaCrearUnCiclista() {
		...
		assertEquals((Integer) 3, nuevo.getNum_socio());
	}
	...
	public void  queSePuedaCrearUnTriatleta() {
		...
		assertEquals(TipoDeEvento.TRIATLON_OLIMPICO,nuevo.getTipo_evento());
		assertEquals(TipoDeBicicleta.TRIA, nuevo.getTipo_bicicleta());
		assertEquals((Integer)4, nuevo.getNum_socio());
	}
